...
<template>
    ...
    <body>
        ...
        <div class="chosee-work-container funkyradio card-body list-group-flush mx-auto card-body">
            <div class=" funkyradio-default card-body list-group-item-action list-group-item-light p-3">
                <h1 class="h1 mb-1 text-center ">BIENVENIDO</h1>
                <h4 class="text-uppercase fw-weight-bold mb-0 text-center ">Escoge el servicio que estás buscando</h4>
                <p class="text-gray fst-italic mb-0 text-center pb-4">Hay varios trabajadores esperando por ofrecer sus
                    servicios</p>
                <li class=" d-flex rounded-0 card-body align-items-center justify-content-between">
        ...
        <div class="card mx-auto justify-content-center rounded border-0 shadow-sm position-relative">
            <div class="card-body p-5">
                <div class="form-check mb-3" v-for="(job, index) in jobsOffered" :key="job.job_offered_id">
                    ...
                    <label class="form-check-label" :for="`form-check-input-${job.job_offered_id}-${index}`">
                        ...
                        <button @click="signJobOffered(job, units[index])"> Contratar</button>
                    </label>
